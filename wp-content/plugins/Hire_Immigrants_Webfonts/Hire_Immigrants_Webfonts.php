...
/*
Plugin Name: Hire_Immigrants_Webfonts #3466583
...
add_action( 'admin_init', array('MyFontsInstaller_3466583','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3466583','mffonts_loadupWebfonts' ));